...
CREATE VIEW [dbo].[Kristy_Internal_HO_Prices] as
select WWS.NEW, WWS.YS, BI.CODENO,  WWS.REGNAME, WWS.CODENAME, WWS.D,M.PTAM, HP.NEWCOST, HP.NEWSELL, CAST(((HP.NEWSELL - HP.NEWCOST)/HP.NEWSELL)*100 AS DECIMAL(4,1)) AS GP, HP.RETAIL, 
...
BI2.STYPE = 'X' AND BI2.ACTIVE = -1 AND BI2.CODENO NOT LIKE ('514%') LEFT OUTER JOIN HSXDPRICE HPSXD ON BI2.CODENO = HPSXD.CODENO WHERE BI.STYPE = 'C'  AND BI.ACTIVE <> 0
UNION ALL select WWS.NEW, WWS.YS,BI.CODENO,  WWS.REGNAME, WWS.CODENAME, WWS.D, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,  WWS.HOUSED, NULL, WWS.DOB, WWS.UDT, 
